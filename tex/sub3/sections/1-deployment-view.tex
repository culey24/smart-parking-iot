...
\begin{tikzpicture}[node distance=2cm, auto]
    ...
    \node[draw, fill=blue!20, minimum width=2.5cm, minimum height=0.8cm, align=center] (frontend) at (0,1.5) {Frontend\\(React/Vite)};
    \node[draw, fill=green!20, minimum width=2.5cm, minimum height=0.8cm, align=center] (backend) at (6,1.5) {Backend\\(Node.js/Express)};
    \node[draw, fill=purple!20, minimum width=2.5cm, minimum height=0.8cm, align=center] (iot) at (3,-1) {IoT Gateway\\(MQTT - Planned)};

    % Users and devices
    \node[draw, fill=gray!20, minimum width=2cm, minimum height=0.6cm, align=center] (users) at (-2,0) {Users\\(Web/Mobile)};
    \node[draw, fill=gray!20, minimum width=2cm, minimum height=0.6cm, align=center] (devices) at (3,-2.5) {IoT Devices\\(Sensors/Gates)};
...
\begin{itemize}
\item \textbf{Deploy Platform:} Vercel.
...
\begin{itemize}
\item \textbf{Deploy Platform:} Railway - Cloud application hosting
...
\begin{itemize}
\item \textbf{Service:} Railway's MongoDB.
