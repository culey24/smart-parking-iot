...
\begin{figure}[H]
\centering
% \includegraphics[width=\textwidth]{figures/class-diagram/class-diagram.png}
\fbox{\parbox{\textwidth}{\centering
\textbf{Class Diagram Placeholder}\par
\textit{Please insert the Draw.io exported class diagram here}\par
\textit{File: figures/class-diagram/class-diagram.png}
}}
\caption{Complete Class Diagram - Smart Parking IoT System}
