...
import {
  ...
  useCallbackRef,
  useId
} from "./chunk-XAQPKBFG.js";
import {
  Primitive,
  composeEventHandlers,
  createContextScope,
  useControllableState
} from "./chunk-SBHSTBNB.js";
import "./chunk-6ZTKJVT4.js";
import {
  composeRefs,
  useComposedRefs
} from "./chunk-PX5UGDJG.js";
import {
  require_jsx_runtime
...
var TabsContent = React5.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React5.useRef(isSelected);
    React5.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
    return (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime6.jsx)(
      Primitive.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
